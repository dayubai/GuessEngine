...
public class OZLottoController {
	...
	public ModelAndView ozLottoTicket(@PathVariable String ticketId)
	{
	...
	public ModelAndView ozLottoTicket(@RequestParam("draws") String draws, @RequestParam("games") String games)
	{
		ModelAndView modelAndView = new ModelAndView("ticket/ozLottoTicket");	
