...
public class SaturdayLottoServiceImpl extends AbstractLottoService<SaturdayLottoTicket, SaturdayLottoResult, SaturdayLottoPrediction> {
    ...
    {
        // build model	
    	buildForrestRandomModel(Integer.parseInt(drawNumber));
    	
    	// DB Object
    	SaturdayLottoPrediction saturdayLottoPrediction = new SaturdayLottoPrediction();
    	saturdayLottoPrediction.setDrawNumber(drawNumber);
